...
### Compute the intersection information for rays and AABB
...
### Compute the intersection information between rays and a set of spheres
...
### Compute the information for RGB, depth and opacity
